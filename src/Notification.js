...
import {Platform, StyleSheet, Text, View, ScrollView, Image, Alert, StatusBar} from 'react-native';
...
export default class Notification extends Component {
	...
	async createNotificationListeners() {
	  ...
	  * */
	  ...
	  const channel = new firebase.notifications.Android.Channel('seeinghearts_notification_channel', 'SeeingHearts', firebase.notifications.Android.Importance.Max)
	    .setDescription('SeeingHearts Channel');
	...
	render() {
		return(
			<View>
				...
				<Text style={css.cardTitle}>Hi innnnnn</Text>
